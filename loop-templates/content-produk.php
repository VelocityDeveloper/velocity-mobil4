            ...
            <div class="row pb-3">
                <div class="col-md-6 mb-2 text-center">
                    ...
                    if (has_post_thumbnail()) {
                        ...
                        echo '<img src="' . esc_url(get_template_directory_uri() . '/assets/images/no-image.png') . '" class="img-fluid rounded" alt="No Image">';
                    }
                    ?>
                </div>
                <div class="col-md-6">
                            ...
                            if (!empty($kategori_produk)) {
                                if (!is_wp_error($kategori_produk)) {
                                    ...
                                    foreach (array_reverse($kategori_produk) as $term) {
                                        echo '<span><a href="' . esc_url(get_term_link($term->slug, 'kategori-produk')) . '">' . esc_html($term->name) . '</a></span>, ';
                                    }
                                    echo '</td>';
                                    echo '</tr>';
                                }
